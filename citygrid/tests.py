...
class ModelTests(unittest.TestCase):
    ...
    def test_search_result(self):
        ...
        self.assertEquals(result.query_id, None)
        ...
        self.assertEquals(result.did_you_mean, None)
        ...
        self.assertEquals(location.distance, None)
        self.assertEquals(location.image, None)
        self.assertEquals(location.phone_number, '3105683375')
        self.assertEquals(location.fax_number, None)
        self.assertEquals(location.rating, 8)
        self.assertEquals(location.tagline, None)
        ...
        self.assertEquals(location.website, None)
        self.assertFalse(location.has_video)
        self.assertFalse(location.has_offers)
        self.assertEquals(location.offers, None)
        ...
        self.assertEquals(location.expansion.count, None)
        self.assertEquals(location.expansion.uri, None)
